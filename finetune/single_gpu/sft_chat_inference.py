...
# Initialize model and tokenizer, FastLanguageModel handle PEFT merge automatically
# @see https://github.com/unslothai/unsloth/blob/a5968f30b2655dac89cee670d7db9a18bcb9728b/unsloth/models/loader.py
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = "qwen2.5-3B-chat", 
